...
public class BreadthFirstSearch extends ASearchingAlgorithm{
    ...
    public Solution solve(ISearchable TheProblem){
        ...
        Queue<AState> AState_WhoFound=new PriorityQueue<AState>();
        //
